                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="unit-table" width="100%">
                                <thead>
                                    <tr>
                                        <th width="5%">#</th>
                                        <th>Nama</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            datatableCall('unit-table', '{{ route('admin.unit.index') }}', [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
                {
            ...
            $("#saveData").submit(function(e) {
                ...
                const successCallback = function(response) {
                    ...
                    handleSuccess(response, "unit-table", "createModal");
                };
